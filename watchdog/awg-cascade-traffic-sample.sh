...
#
# Ретенция: раз в сутки прунит строки старше TRAFFIC_RETENTION_DAYS (по умолч. 3 сут = 72ч).
# Объём: ~10 пиров × 288 замеров/сут ≈ 150 КБ/сут, то есть при 3 сутках ~450 КБ.
# (Ретенция снижена с 14 суток до 72 часов в v2.0.31 — меньше хранимых метаданных.)
# =============================================================================
set -u
